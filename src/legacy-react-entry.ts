 ...
 *
 * @deprecated Since 0.11.0. Import framework-neutral APIs from `annota` and React
...
/** @deprecated Since 0.11.0. Import from `annota/react`. Planned removal: 2.0.0. */
...
/** @deprecated Since 0.11.0. Import `Viewer` from `annota/react`. Planned removal: 2.0.0. */
export const AnnotaViewer = ReactEntry.Viewer;
/** @deprecated Since 0.11.0. Import `ViewerProps` from `annota/react`. Planned removal: 2.0.0. */
