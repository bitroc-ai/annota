...
```bash
npm install annota@0.9.1
# or
pnpm add annota@0.9.1
```
...
- chore: pkg fix (a5538d2)
- 0.8.11 (0a83b15)
- perf: improve pan/zoom rendering (eaafd80)

### Installation

```bash
npm install annota@0.8.11
# or
pnpm add annota@0.8.11
```
...
- 0.8.10 (5ee4ee8)
- feat: enhance split tool with polyline, batch split support and notifications (ed98a1d)

### Installation

```bash
npm install annota@0.8.10
# or
pnpm add annota@0.8.10
```
...
- 0.8.9 (4190966)
- 🐛 fix: merge SAM annotation properties into properties object instead of annotation root (a05a66f)

### Installation

```bash
npm install annota@0.8.9
# or
pnpm add annota@0.8.9
```
...
```bash
npm install annota@0.8.8
# or
pnpm add annota@0.8.8
```
...
- chore: bump version to 0.8.5 (638ce10)
- fix(tools): properly store bound handler references for correct event removal (171cac4)

### Installation

```bash
npm install annota@0.8.5
# or
pnpm add annota@0.8.5
```
...
- chore: bump version to 0.8.4 (9a08f04)
