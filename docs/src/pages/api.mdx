...
- **[Svelte Functions](/api/hooks)** - Functions for accessing annotations, selection, and interactions
- **[Components](/api/components)** - Svelte components for building annotation UIs
