...
<div class="relative">
  {#if trigger}
    <button
      ...
      class="w-9 h-9 p-1 hover:bg-slate-100 dark:hover:bg-slate-800 rounded transition-colors"
      title="Layers"
    >
  ...
  {#if dropdownOpen}
    <div
      class="absolute left-12 top-0 z-50 w-[320px] rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shadow-lg"
