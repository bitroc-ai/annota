...
- fix: support Node 20 while building docs on Node 22 (cb68ed8)

### Installation

```bash
npm install annota@0.11.1
# or
pnpm add annota@0.11.1
```
...
```bash
npm install annota@0.11.0
# or
pnpm add annota@0.11.0
```
