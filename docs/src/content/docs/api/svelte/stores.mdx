...
Get currently selected annotations as a reactive array.
...
<Aside type="tip">
  **Svelte 5 Runes**: Unlike React hooks, Svelte stores don't need dependency arrays. The `$effect` automatically tracks reactive dependencies.
</Aside>
