...
```tsx
import { AnnotaProvider, Viewer as AnnotaViewer, Annotator, useTool } from "annota/react";
...
```tsx
import { useAnnotations, useSelection } from "annota/react";
...
```tsx
import { useAnnotations } from "annota/react";
