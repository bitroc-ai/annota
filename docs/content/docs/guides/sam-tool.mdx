...
<Cards>
  <Cards.Card title="Annotation Tools" href="/docs/guides/tools" />
  <Cards.Card title="Meta SAM Repository" href="https://github.com/facebookresearch/segment-anything" />
  <Cards.Card title="ONNX Runtime Node" href="https://onnxruntime.ai/docs/get-started/with-javascript/node.html" />
</Cards>
