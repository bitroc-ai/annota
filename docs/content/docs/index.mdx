...
import { Zap, Palette, Plug, Layers, Database, Atom, Microscope, Brain, Hospital, FlaskConical, Hash, Target, BookOpen, GraduationCap, FileText, Lightbulb, Gamepad2, Building } from "lucide-react";
...
<Cards num={3}>
  <Cards.Card icon={<Zap />} title="High Performance" href="/docs/guides/tools" />
  <Cards.Card icon={<Palette />} title="Purpose-Built for Pathology" href="/docs/guides/tools" />
  <Cards.Card icon={<Plug />} title="Event-Driven Architecture" href="/docs/guides/events" />
  <Cards.Card icon={<Layers />} title="Multi-Layer Organization" href="/docs/guides/layers" />
  <Cards.Card icon={<Database />} title="Flexible Data Loading" href="/docs/guides/loaders" />
...
<Cards num={3}>
  <Cards.Card icon={<Microscope />} title="Digital Pathology" href="/docs/guides/tools" />
  <Cards.Card icon={<Brain />} title="AI Training" href="/docs/guides/loaders" />
  <Cards.Card icon={<Hospital />} title="Clinical Workflows" href="/docs/examples/basic-viewer" />
  <Cards.Card icon={<FlaskConical />} title="Research" href="/docs/guides/events" />
  <Cards.Card icon={<Hash />} title="Cell Counting" href="/docs/guides/tools" />
  <Cards.Card icon={<Target />} title="Tumor Segmentation" href="/docs/guides/tools" />
</Cards>

## Next Steps

<Cards num={3}>
  <Cards.Card icon={<BookOpen />} title="Getting Started" href="/docs/getting-started" />
  <Cards.Card icon={<GraduationCap />} title="Guides" href="/docs/guides/tools" />
  <Cards.Card icon={<FileText />} title="API Reference" href="/api" />
  <Cards.Card icon={<Lightbulb />} title="Examples" href="/docs/examples/basic-viewer" />
  <Cards.Card icon={<Gamepad2 />} title="Playground" href="/playground" />
  <Cards.Card icon={<Building />} title="Architecture" href="/docs/architecture" />
</Cards>
